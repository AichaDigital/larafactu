<div>
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-base-content/60 text-sm mt-1">{{ $customer->name }} - {{ $customer->email }}</p>
        </div>
    </div>
    ...
    <form wire:submit="save">
        ...
        <x-ui.card class="mb-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold">Datos Fiscales</h2>
                @if($taxProfile)
                    <span class="badge badge-success badge-sm">Perfil activo desde {{ $taxProfile->valid_from->format('d/m/Y') }}</span>
                @endif
            </div>

            @if($taxProfile)
                <x-ui.alert type="info" class="mb-4">
                    Al modificar datos fiscales, se creara un nuevo perfil fiscal con fecha de hoy. El perfil anterior se mantendra para facturas historicas.
                </x-ui.alert>
            @endif
