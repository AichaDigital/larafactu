<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-base-content/60 text-sm mt-1">
                <span class="font-mono">{{ $invoice->fiscal_number }}</span> - {{ $this->getSerieLabel() }}
            </p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('invoices.show', $invoice) }}" class="btn btn-ghost gap-2" wire:navigate>
    ...
    <x-ui.alert type="info" class="mb-6">
        La serie y numero fiscal no pueden modificarse una vez creada la factura.
    </x-ui.alert>
                                ...
                                <div class="flex items-start gap-4">
                                    <div class="flex-1 grid grid-cols-1 md:grid-cols-12 gap-4">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            />
                                            <p class="text-xs text-base-content/50 mt-1">En centimos</p>
                                        </div>
            ...
            <div class="space-y-6">
                ...
                <x-ui.card>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="label">Numero fiscal</label>
                            <input
                                type="text"
                                value="{{ $invoice->fiscal_number }}"
