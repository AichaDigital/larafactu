...
<div id="step-company" x-data="{ isRoi: false }">
    ...
    <form id="step-form" class="space-y-6">
        ...
        <div class="bg-slate-700/50 rounded-lg p-4">
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="trade_name" class="block text-sm font-medium text-slate-300 mb-1">
                            <?= __('company.trade_name') ?>
                        </label>
                        <input 
                            type="text" 
                            name="trade_name" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium text-slate-300 mb-1">
                            <?= __('company.email') ?> <span class="text-red-400">*</span>
                        </label>
                        <input 
                            type="email" 
                            name="email" 
        ...
        <div class="bg-slate-700/50 rounded-lg p-4">
            ...
            <div class="space-y-4">
                <div>
                    <label for="address_line1" class="block text-sm font-medium text-slate-300 mb-1">
                ...
                <div>
                    <label for="address_line2" class="block text-sm font-medium text-slate-300 mb-1">
                        <?= __('company.address_line2') ?>
                    </label>
                    <input 
                        type="text" 
                        name="address_line2" 
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        <label for="postal_code" class="block text-sm font-medium text-slate-300 mb-1">
                    ...
                    <div>
                        <label for="province" class="block text-sm font-medium text-slate-300 mb-1">
                            <?= __('company.province') ?> <span class="text-red-400">*</span>
                        </label>
                        <input 
                            type="text" 
                            name="province" 
        ...
        <div class="bg-slate-700/50 rounded-lg p-4">
            ...
            <div class="space-y-4">
                ...
                <div x-show="isRoi" x-transition class="pl-8">
                    <label for="eu_vat" class="block text-sm font-medium text-slate-300 mb-1">
                        <?= __('company.eu_vat') ?> <span class="text-red-400">*</span>
                    </label>
                    <input 
                        type="text" 
                        name="eu_vat" 
                    ...
                    >
                    <p class="text-xs text-slate-500 mt-1"><?= __('company.eu_vat_help') ?></p>
                </div>
